...
<body>
        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center me-4">
                    ...
                    <small>Manuel Montt 357, Oficina 708, Curicó</small>
                </div>
                <div class="h-100 d-inline-flex align-items-center">
                    <small class="far fa-clock text-primary me-2"></small>
                    <small>Lunes - Viernes : 09.00 AM - 06.00 PM</small>
                </div>
            </div>
            <div class="col-lg-5 px-5 text-end">
                <div class="h-100 d-inline-flex align-items-center me-4">
                    <small class="fa fa-phone-alt text-primary me-2"></small>
                    <small>+56 75 2 414833 / +56 9 42651531</small>
                </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-3">
        <a href="index.html" class="navbar-brand d-flex align-items-center border-end px-4 px-lg-5">
            <img class="img-fluid"  alt="Intraterra Logo" style="max-height: 85px; width: auto;" src="<?php echo get_template_directory_uri(); ?>/img/icon_big.png">
            <h2 class="m-0 text-primary">Banco de Inversiones</h2>
        </a>
    ...
    ?>
            <a href="<?php echo home_url('/contacto/'); ?>" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">Escríbenos<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->