<?php
/* Template Name: Página Administración de Fondos */
get_header(); ?>
    ...
    <div class="container-fluid page-header-service-fund-managment py-5 mb-5 d-flex align-items-center justify-content-center">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Administración de Fondos</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-white active" aria-current="page">Administración de Fondos</li>
                </ol>
            </nav>
        </div>
    </div>
